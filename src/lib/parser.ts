...
function peg$parse(input, options) {
  ...
  const peg$startRuleFunctions = {
    Flow: peg$parseFlow,
    SingleScreen: peg$parseSingleScreen,
  };
  let peg$startRuleFunction = peg$parseFlow;

  const peg$c0 = "Pantalla";
  const peg$c1 = ":";
  const peg$c2 = "Opciones:";
  const peg$c3 = ".";
  ...
  const peg$e0 = peg$literalExpectation("Pantalla", false);
  const peg$e1 = peg$literalExpectation(":", false);
  const peg$e2 = peg$literalExpectation("Opciones:", false);
  ...
  function peg$parseSingleScreen() {
    let s0, s1, s2, s3;
